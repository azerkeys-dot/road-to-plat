      ...
      <header className="sticky top-0 z-20 backdrop-blur bg-gray-900/80 border-b border-gray-800">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-3">
          <Link to="/" className="flex items-center gap-3 font-semibold text-gray-100 group logo-wrap">
            <img src="/rtp-logo-platine-2025.svg?v=1001" alt="Road to Plat" className="h-14 w-14 rounded-xl ring-1 ring-emerald-500/30 group-hover:ring-emerald-400/60 transition"/>
            Road to Plat
          </Link>
